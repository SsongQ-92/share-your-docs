...
import { NO_EXIST_DOC_URL } from "../../constants/errorMessage";

export default function NotFoundPage({ isNoExistDocUrlError }) {
  ...
  return (
    <main className="w-full h-screen flex-col-center gap-60 bg-black-dark">
      <nav>
        <Link to="/">
      ...
      <div className="flex-col-center gap-10">
        ...
        <h3 className="text-red-5 text-22 mb-10">
          {isNoExistDocUrlError ? NO_EXIST_DOC_URL : "없는 Doc 페이지 입니다 !!!"}
        </h3>
...
NotFoundPage.propTypes = {
  isNoExistDocUrlError: PropTypes.string,
};
